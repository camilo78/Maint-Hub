            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <div className="bg-background overflow-x-auto rounded-lg border">
                    <Table>
                                        ...
                                        <TableRow key={maintenance.id}>
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-2">
                                                    <div className={`w-4 h-4 rounded-full ${getPriorityColor(maintenance.priority)}`}></div>
                                                    <span className={`font-medium ${getPriorityTextColor(maintenance.priority)}`}>{translatePriority(maintenance.priority)}</span>
                                                </div>
                                            </TableCell>
                                            ...
                                            <TableCell>
                                                <div>
                                                    ...
                                                    <div className="text-xs text-muted-foreground">{maintenance.equipment.asset_tag}</div>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableRow className="bg-muted/50">
                                                ...
                                                <TableCell colSpan={9} className="py-3">
                                                    <div className="text-sm">
                                                        <span className="font-medium text-muted-foreground">{es['Description'] || 'Descripción'}: </span>
                                                        <span className="break-words hyphens-auto whitespace-normal">{maintenance.description}</span>
                                                    </div>
                                                </TableCell>
                                            </TableRow>
                                        )}
                        ...
                        <TableFooter>
                            <TableRow>
                                <TableCell colSpan={10} className="text-sm text-muted-foreground text-right py-3 pr-4">
                                    {es['Showing']} {(maintenances.current_page - 1) * maintenances.per_page + 1} {es['to']} {(maintenances.current_page - 1) * maintenances.per_page + maintenances.data.length} {es['of']} {maintenances.total} {es['maintenances'] || 'mantenimientos'}
                                </TableCell>
                            </TableRow>
                        </TableFooter>
                    </Table>
