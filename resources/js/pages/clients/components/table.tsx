                                    ...
                                    <TableCell className="text-center">
                                        <div>
                                            ...
                                            <div className="text-xs text-muted-foreground">
                                                {user.tipo === 'corporativo' ? es['RTN'] : 
                                                 user.tipo === 'extranjero' ? es['Passport'] : 
                                                 es['DNI']}
                                            </div>
                                        </div>
                                    </TableCell>
                                        ...
                                        <TableRow className="bg-muted/50">
                                            ...
                                            <TableCell colSpan={6} className="py-3">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                    <div>
                                                        <span className="font-medium text-muted-foreground">{es['Email']}: </span>
                                                        <span>
                                                        {user.email ? (
                                                    ...
                                                    <div className="max-w-xs">
                                                        <span className="font-medium text-muted-foreground">{es['Address']}: </span>
                    ...
                    <TableFooter>
                        <TableRow>
                            <TableCell colSpan={7} className="text-sm text-muted-foreground text-right py-3 pr-4">
                                {es['Showing']} {(users.current_page - 1) * users.per_page + 1} {es['to']} {(users.current_page - 1) * users.per_page + users.data.length} {es['of']} {users.total} {es['users']}
                            </TableCell>
                        </TableRow>
                    </TableFooter>
                </Table>
